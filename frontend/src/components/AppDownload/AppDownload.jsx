  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-[#fff8f3] via-[#fffaf7] to-[#ffe7d4] py-24">
      ...
      <div className="relative mx-auto max-w-4xl px-6 text-center">
        <h2 className="font-extrabold leading-tight text-slate-900 sm:text-5xl">
          Download the{" "}
        ...
        <div className="mt-10 flex flex-col items-center gap-5 sm:flex-row sm:justify-center">
          <a
            href="#"
            className="rounded-2xl bg-black px-8 py-4 font-bold text-white shadow-lg transition hover:-translate-y-1"
          >
            App Store
          </a>
